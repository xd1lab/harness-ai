...
// at limit (the M read-superset method; the MCP facade never exercises it but the
...
// superset methods; the MCP facade never exercises them but the fake must satisfy
